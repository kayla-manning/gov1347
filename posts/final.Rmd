...
![State-level 95% confidence intervals](../figures/final/state_plots.jpg)
...
The below figure plots the coefficients for each model. With near-zero p-values and incredibly narrow 95% confidence intervals, all coefficients are extremely significant:
